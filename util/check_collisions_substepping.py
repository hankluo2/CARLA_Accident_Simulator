...
class CollisionScenarioTester():
    ...
    def test_scenario(self, fps=20, fps_phys=100, repetitions=1, sim_tics=100):
        output_str = "Testing Determinism in %s for %3d render FPS and %3d physics FPS -> " % (self.scenario_name, fps,
                                                                                               fps_phys)
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--filter', metavar='PATTERN', default='model3', help='actor filter (default: "vehicle.*")')
