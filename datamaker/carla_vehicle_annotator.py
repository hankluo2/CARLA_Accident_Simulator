...
def auto_annotate(vehicles,
    ...
    if json_path is not None:
        ...
        vehicle_class = []
    filtered_out, removed_out, _, _ = filter_occlusion_bbox(bounding_boxes_2d, vehicles, camera, depth_img, vehicle_class,
                                                            depth_show, depth_margin, patch_ratio, resize_ratio)
    return filtered_out, removed_out


# Same with auto_annotate(), but with debugging function for the occlusion filter
def auto_annotate_debug(vehicles,
                        camera,
                        depth_img,
                        depth_show=False,
                        max_dist=100,
    ...
    if json_path is not None:
        ...
        vehicle_class = []
    filtered_out, removed_out, depth_area, depth_show = filter_occlusion_bbox(bounding_boxes_2d, vehicles, camera, depth_img,
                                                                              vehicle_class, depth_show, depth_margin,
                                                                              patch_ratio, resize_ratio)
...
def filter_occlusion_bbox(bounding_boxes,
                          vehicles,
                          sensor,
                          depth_img,
                          v_class=None,
